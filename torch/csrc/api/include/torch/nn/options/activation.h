...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(ELU);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(SELU);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(Hardshrink);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(Hardtanh);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(LeakyReLU);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(Softmax);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(Softmin);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(LogSoftmax);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(PReLU);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(ReLU);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(ReLU6);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(RReLU);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(CELU);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(Softplus);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(Softshrink);
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(Threshold);
