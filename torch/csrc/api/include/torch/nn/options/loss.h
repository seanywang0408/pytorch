...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(L1Loss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(KLDivLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MSELoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(BCELoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(HingeEmbeddingLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MultiMarginLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(CosineEmbeddingLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MultiLabelMarginLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(SoftMarginLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MultiLabelSoftMarginLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(TripletMarginLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(CTCLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(SmoothL1Loss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(PoissonNLLLoss)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MarginRankingLoss)
