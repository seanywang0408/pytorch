...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AvgPool1d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AvgPool2d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AvgPool3d)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MaxPool1d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MaxPool2d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MaxPool3d)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AdaptiveMaxPool1d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AdaptiveMaxPool2d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AdaptiveMaxPool3d)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AdaptiveAvgPool1d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AdaptiveAvgPool2d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(AdaptiveAvgPool3d)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MaxUnpool1d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MaxUnpool2d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(MaxUnpool3d)
...
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(LPPool1d)
TORCH_NN_FUNCTIONAL_REUSE_MODULE_OPTIONS(LPPool2d)
